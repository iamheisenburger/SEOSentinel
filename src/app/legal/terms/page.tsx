    ...
    <div className="min-h-screen bg-[#08090E] text-[#F1F5F9]">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mt-10 space-y-8 text-[#94A3B8] leading-relaxed [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-[#F1F5F9] [&_h2]:mt-10 [&_h2]:mb-3 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-1">
          ...
          <p>Pentra integrates with third-party services including GitHub, WordPress, webhook endpoints for publishing, Search Console for measurement, a separately authorized Gmail mailbox for approval-first outbound outreach, and an audited signed receiving-only relay for replies, routed structured bounces, and opt-out requests. New Gmail connections request send access only and cannot release prospect mail until an owner-triggered fixed-recipient canary proves current bounce routing for that mailbox; existing readonly connections may use bounded human-reply and exact-recipient opt-out monitoring until migration. You are responsible for maintaining valid credentials, Google Workspace delivery-status routing, DNS, sender identity, mailing address, message approval, permissions, and a lawful basis for outreach. We are not responsible for third-party outages, retention terms, routing failures, or service changes.</p>
