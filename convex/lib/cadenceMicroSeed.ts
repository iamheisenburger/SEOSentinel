...
// request fail upstream. Native phrase-match supplies the provider-side
// relevance fence; the independent two-concept anchor, business-fit,
// difficulty, SERP, expected-click, and article-quality gates remain exact.
